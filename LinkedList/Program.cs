    ...
    internal class Program
    {
		 ...
		 ******************************************************/
            ...
            void LinkedList()
            {
                ...
                DataStructure.LinkedListNode<string> findNode = linkedList.Find("0번 앞데이터");
                linkedList.Print("0번 앞데이터");
            ...
            linkedList.AddFirst("0번 앞데이터");
            DataStructure.LinkedListNode<string> findNode = linkedList.Find("0번 앞데이터");
            linkedList.Print(findNode);
            Console.WriteLine();
            linkedList.AddFirst("1번 앞데이터");
            findNode = linkedList.Find("0번 앞데이터");
            linkedList.Print(findNode);
            findNode = linkedList.Find("1번 앞데이터");
            linkedList.Print(findNode);
        }
    }
}